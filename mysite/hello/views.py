...
def cookie(request):
    ...
    if oldval :
        ...
        resp.set_cookie('dj4e_cookie', 'a727a09b') # No expired date = until browser close
    resp.set_cookie('dj4e_cookie', 'a727a09b', max_age=1000) # seconds until expire
    return resp
...
def myview(request) :
    ...
    resp.set_cookie('dj4e_cookie', 'a727a09b', max_age=1000)
    return resp